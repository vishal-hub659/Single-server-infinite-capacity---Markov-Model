...
Robot_time = float(input("Enter the time taken by the Robot (in secs) : "))
...
<img width="758" height="330" alt="image" src="https://github.com/user-attachments/assets/a95f750f-ec97-4e49-9380-cc26c7b5e81b" />
